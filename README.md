...
Integrate challenge 1 to Rails
...
```
git clone git@github.com:clarkngo/fh-homework-06.git
```
...
* [File Bug Reports and Features](https://github.com/clarkngo/fh-homework-06/issues)
